...
\begin{figure}
  \begin{tikzpicture}[x=.2cm, y=.2 cm ]
    \draw plot[mark=*, xshift=12cm, only marks] file {unweighted-fra.dat};
    \draw plot[mark=+, xshift=12cm, only marks] file {unweighted-seq.dat};
    \draw plot[xshift=12cm, id=x-ax] function { "unweighted-deg.dat" using 3:2:xticlabels(1)}; 
  \end{tikzpicture}
\end{figure}
